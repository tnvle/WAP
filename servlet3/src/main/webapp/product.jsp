...
<div id="productTitle"><h1>New Arrivals</h1></div>
<div class="rowitem">
    <c:forEach items="${newProducts}" var="product">
        <%--      <c:url value='shopping-cart' var="linkAddToCart">--%>
        <%--        <c:param name="productId" value="${product.productId}"/>--%>
        <%--      </c:url>--%>
        <div class="col-lg-3 col-md-3 col-xs-6 item">
...
<%--        &lt;%&ndash;    <c:url value='shopping-cart' var="linkAddToCart">&ndash;%&gt;--%>
<%--        &lt;%&ndash;      <c:param name="productId" value="${product.productId}"/>&ndash;%&gt;--%>
<%--        &lt;%&ndash;    </c:url>&ndash;%&gt;--%>
